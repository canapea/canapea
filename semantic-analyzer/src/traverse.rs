...
//!
//! use crate::{traverse, traverse_tree, Order};
//! # fn get_tree() -> Tree {
...
"#;
    ...
    fn example() {
        ...
        let preorder: Vec<Node<'_>> =
            traverse(tree.walk(), Order::Pre).collect::<Vec<_>>();
        let postorder: Vec<Node<'_>> =
