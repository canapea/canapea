package io.github.treesitter.jtreesitter.sol3;

import java.lang.foreign.*;

public final class TreeSitterSol3 {
    ...
    private static final TreeSitterSol3 INSTANCE = new TreeSitterSol3();

    private final Arena arena = Arena.ofAuto();
    private volatile SymbolLookup lookup = null;

    private TreeSitterSol3() {}
    ...
    public static MemorySegment language(SymbolLookup lookup) {
        return call(lookup, "tree_sitter_sol3");
    }

    private SymbolLookup findLibrary() {
        try {
            var library = System.mapLibraryName("tree-sitter-sol3");
            return SymbolLookup.libraryLookup(library, arena);
        } catch (IllegalArgumentException ex1) {
            try {
                System.loadLibrary("tree-sitter-sol3");
