...
(module_name_definition privileged_namespace: (canapea) @keyword.type.canapea)
(module_name_definition privileged_namespace: (experimental) @keyword.type.canapea)
(module_name_definition (module_name_path_fragment) @string.canapea)
(module_import_name privileged_namespace: (canapea) @keyword.type.canapea)
(module_import_name privileged_namespace: (experimental) @keyword.type.canapea)
(module_import_name namespace: (_) @keyword.other.canapea)
(module_import_name (module_name_path_fragment) @string.canapea)
