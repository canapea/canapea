...
#pragma region tree-sitter raw Scanner interface

bool tree_sitter_lang0_external_scanner_scan(
    void* payload,
    TSLexer* lexer,
...
void* tree_sitter_lang0_external_scanner_create() {
    return (Scanner*)ts_calloc(1, sizeof(Scanner));
}

void tree_sitter_lang0_external_scanner_destroy(void* payload) {
    Scanner* scanner = (Scanner*)payload;
    destroy(scanner);
}

unsigned tree_sitter_lang0_external_scanner_serialize(
    void* payload,
    char* buffer
) {
    Scanner* scanner = (Scanner*)payload;
...
void tree_sitter_lang0_external_scanner_deserialize(
    void* payload,
    const char *buffer,
    unsigned length
) {
